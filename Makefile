...
ToplingDcompact_lib := topling-dcompact
ToplingDcompact_src := $(wildcard src/table/*.cc)
ToplingDcompact_src += ${BUILD_ROOT}/git-version-topling_dcompact.cc
...
ToplingDcompact_d_o := $(call objs,ToplingDcompact,d)
ToplingDcompact_r_o := $(call objs,ToplingDcompact,r)
ToplingDcompact_d := ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-${COMPILER}-d${DLL_SUFFIX}
ToplingDcompact_r := ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-${COMPILER}-r${DLL_SUFFIX}
static_ToplingDcompact_d := ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-${COMPILER}-d.a
static_ToplingDcompact_r := ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-${COMPILER}-r.a

ALL_TARGETS = ToplingDcompact
DBG_TARGETS = ${ToplingDcompact_d}
RLS_TARGETS = ${ToplingDcompact_r}

.PHONY : default all ToplingDcompact

default : ToplingDcompact
all : ${ALL_TARGETS}
ToplingDcompact: ${ToplingDcompact_d} \
                 ${ToplingDcompact_r} \
          ${static_ToplingDcompact_d} \
          ${static_ToplingDcompact_r}

allsrc = ${ToplingDcompact_src}
...
${ToplingDcompact_d} ${ToplingDcompact_r} : LIBS += -lrt
endif

#${ToplingDcompact_d} : override LIBS := ${LIB_TERARK_D} ${LIBS} -ltbb_debug
${ToplingDcompact_d} : override LIBS := ${LIB_TERARK_D} ${LIBS} #-ltbb
${ToplingDcompact_r} : override LIBS := ${LIB_TERARK_R} ${LIBS} #-ltbb

${ToplingDcompact_d} ${ToplingDcompact_r} : LIBS += -lpthread

${ToplingDcompact_d} : $(call objs,ToplingDcompact,d)
${ToplingDcompact_r} : $(call objs,ToplingDcompact,r)
${static_ToplingDcompact_d} : $(call objs,ToplingDcompact,d)
${static_ToplingDcompact_r} : $(call objs,ToplingDcompact,r)

TarBallBaseName := ${ToplingDcompact_lib}-${BUILD_NAME}
TarBall := pkg/${ToplingDcompact_lib}-${BUILD_NAME}
.PHONY : pkg
.PHONY : tgz
pkg : ${TarBall}
tgz : ${TarBall}.tgz

${TarBall}: ${ToplingDcompact_d} ${static_ToplingDcompact_d} \
            ${ToplingDcompact_r} ${static_ToplingDcompact_r} \
...
ifeq (${PKG_WITH_DBG},1)
	cp -a ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-{${COMPILER}-,}d${DLL_SUFFIX} ${TarBall}/lib
  ...
  ifeq (${PKG_WITH_STATIC},1)
	...
	cp -a ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-{${COMPILER}-,}d.a ${TarBall}/lib_static
...
ifeq (${PKG_WITH_STATIC},1)
	mkdir -p ${TarBall}/lib_static
	cp -a ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-{${COMPILER}-,}r.a ${TarBall}/lib_static
...
ifeq (${PKG_WITH_ROCKSDB},1)
  ...
  ifeq (${PKG_WITH_STATIC},1)
	...
	cp -a ${BUILD_ROOT}/lib/lib${ToplingDcompact_lib}-{${COMPILER}-,}r${DLL_SUFFIX} ${TarBall}/lib

...
ifneq (${DLL_SRCS},)
${DLL_BINS_A} : LDFLAGS := ${AFR_ASAN}
${DLL_BINS_D} : LDFLAGS := ${DBG_ASAN}
${DLL_BINS_R} : LDFLAGS := ${RLS_ASAN}
endif

${EXE_BINS_A} : LDFLAGS := ${AFR_ASAN}
${EXE_BINS_D} : LDFLAGS := ${DBG_ASAN}
${EXE_BINS_R} : LDFLAGS := ${RLS_ASAN}
